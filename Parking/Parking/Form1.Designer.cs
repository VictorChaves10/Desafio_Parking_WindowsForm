namespace Parking
{
    partial class Parking
    {
        ...
        private Panel painelHeader;
        private PictureBox picbxHeader;
        private Panel panelVehicleRegistration;
        private Panel panel5;
        private Label labelTitleEntryVehicle;
        private PictureBox picbxEntryVehicle;
        ...
        private Panel pnlLisvViewEntryCar;
        private Panel panelListOfRestered;
        private Label lblTitleVehicleEntry;
        private PictureBox picbxListVehicle;
        private ListView lvVehicleEntrance;
        private Button buttonRemoveVehicle;
        private Panel panelPayment;
        private TextBox textBoxPaymentParkingSpace;
        private Label labelPaymentParkingSpace;
        private Label labelPaymentVehicleType;
        private TextBox textBoxPaymentNumberPalte;
        private Label labelPaymentNumberPlate;
        private TextBox textBoxPaymentVehicleType;
        private ContextMenuStrip contextMenuStrip1;
        private TextBox textBoxPaymentEntryTime;
        private Label labelPaymentEntryTime;
        private TextBox textBoxPaymentExistTime;
        private Label labelPaymentExitTime;
        private Label labelPaymentPrice;
        private Panel panel1;
        private Label textBoxPaymentPricePerPeriod;
        private Label labelPricepeTtime;
